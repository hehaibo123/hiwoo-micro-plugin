declare type SysSaasVerifyInfo = {
    verifyId: string; // 认证信息标识(唯一)
    enterpriseScale: number; // 企业规模
    ...
    techLeadName: string; // 技术负责人姓名
    techLeadEmail: string; // 技术负责人邮箱
    techLeadPhone: string; // 技术负责人手机号
    status: number; // 状态
    businessLicense: string; // 营业执照图片地址
    createTime: T;
    updateTime: T;
    verifyFailReason?: string; // 审核失败原因
};
/**
 * views personal
 */
