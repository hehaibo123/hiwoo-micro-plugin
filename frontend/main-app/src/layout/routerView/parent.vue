<template>
  ...
  <div id="layout-parent" class="layout-parent">

    <router-view v-slot="{ Component }" v-if="!isIframePage ">
    ...
    <div id="application" style="height: 100%"
         v-show="!isIframePage  && router.currentRoute.value.path != '/user-info/index'"></div>
    <transition :name="setTransitionName" mode="out-in">
