...
export default {
    router: {
        ...
        siteConfigurationTemplate: 'Site Template',
        expand: 'Expand',
        videoManage: 'Video Manage',
        alarm: 'Alarm',
        alarmManage: 'Cloud Alarm',
        alarmPrediction: 'Alarm Prediction',
        alarmList: 'Alarm List',
        alarmManagement: 'Alarm Management',
        alarmContact: 'Alarm Contact',
        alarmGateway: 'Gateway Alarm',
        operate: 'Operate',
        integratedScreen: 'Integrated Screen',
        mapMonitor: 'Map Monitor',
        monitorDashboard: 'Dashboard Monitor',
        gatewayTemplate: 'Gateway Template',
        systemSource: 'My Resources'
    },
    staticRoutes: {
        signIn: 'signIn',
        notFound: 'notFound',
    ...
    user: {
        ...
        fillAccountPassword:'Click on the card to quickly fill in the account password',
        demoSystem:'Scan the code to follow and enter the demonstration system'
    },
    tagsView: {
        refresh: 'refresh',
        close: 'close',
