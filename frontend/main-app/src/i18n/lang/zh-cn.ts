...
export default {
    router: {
        ...
        systemStyle: '系统风格',
        systemLog: '系统日志',
        userManageDetails: '用户详情',
        equipment: '设备中心',
        equipmentList: '设备列表',
        equipmentAccess: '设备接入',
        site: '站点中心',
        siteList: '站点列表',
        siteTemplate: '站点模板',
        gatewayTemplate: '网关模板',
        siteConfigurationTemplate: '站点模板',
        analysis: '分析中心',
        analysisIndex: '报表统计',
        chartAnalysis: '图表分析',
        projectCenter: '项目中心',
        ...
        alarmContact: '报警联系人',
        alarmGateway: '网关报警',
        alarmPrediction: '报警预测',
        alarmList: '报警记录',
        alarmManagement: '报警管理',
        operate: '运营中心',
        integratedScreen: '综合大屏',
        mapMonitor: '地图监控',
        monitorDashboard: '看板监控',
        systemSource: '我的资源'
    },
    staticRoutes: {
        signIn: '登录',
    ...
    user: {
        ...
        fillAccountPassword:'点击卡片可快速填充账号密码',
        demoSystem:'扫码关注进入演示系统'
    },
    tagsView: {
        refresh: '刷新',
        close: '关闭',
