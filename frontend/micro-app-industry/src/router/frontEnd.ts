...
import {flattenArray, recursion} from "/@/utils/arrayOperation";
...
export function setFilterRouteEnd() {
    const requestOldRoutes = useRequestOldRoutes().requestOldRoutes;
    const routes = flattenArray(requestOldRoutes);
    recursion(dynamicRoutes, routes);
